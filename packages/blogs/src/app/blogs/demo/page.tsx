...
export default function ReactHooksDeepDive() {
  return (
    <MainWrapper>
      ...
      <p>
        The <span className="bold">useState</span> hook is the most basic hook,
...
function Counter() {
  ...
  return (
    <div>
      ...
      <p>
        <span className="important-text">Important:</span> Always call hooks at
        the top level of your component, never inside loops, conditions, or
        nested functions.
      </p>

      <h2>useEffect: Side Effects in Function Components</h2>
      <p>
        The <span className="bold">useEffect</span> hook lets you perform side
        effects in function components, similar to componentDidMount,
...
function Example() {
  ...
  return (
    <div>
      ...
      <p>
        The <span className="italic">useContext</span> hook makes it easier to
        consume context in your components.
      </p>
...
function ThemedButton() {
  ...
  return (
    <button style={{ background: theme.background, color: theme.foreground }}>
      ...
      <p>
        For more complex state logic, <span className="bold">useReducer</span>{" "}
  ...
  return (
    <>
      ...
      <p>
        ...
        maintainable React components. Remember to follow the Rules of Hooks to
